//
//  HqLineLayout.m
//  HqUICollectionViewLayout
//
//  Created by macpro on 2017/3/28.
//  Copyright © 2017年 macpro. All rights reserved.
//

#import "HqLineLayout.h"

@implementation HqLineLayout
...
-(void)prepareLayout
{
    ...
    //初始化
    self.itemSize = CGSizeMake(45, 150);
    self.scrollDirection = UICollectionViewScrollDirectionHorizontal;
    self.minimumLineSpacing = 1.0;
    CGFloat inset = [UIScreen mainScreen].bounds.size.width/2-25;
